...
base_dir = '/home/tstarr/devel/python/beancount-workflow/data/'
# Location of Json with plaid credentials
plaid_cred_dir = '/home/tstarr/devel/python/beancount-workflow/helper-scripts/plaid/plaid-credentials.json'
# Equate account_id from Plaid and real account names
acc_dict = {
    'Ak0kqX4z9qsqB5pnaQd6fwQEJ9xnYYU6qOaa6': 'plaid_checking',
    'v6p6xbq4ZxtzLakBoJpQhOaM5v8mYYHm3vLLV': 'plaid_savings'
}
